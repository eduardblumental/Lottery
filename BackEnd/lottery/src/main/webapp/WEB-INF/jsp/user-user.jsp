...
<section>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="lms-user-type">User</div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="lms-nav-item nav-item">
                    <a class="nav-link" href="/autentication">Log in as admin</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-lg-6 text-center">
                <div class="lms-lottery-field">
                    ...
                    <button type="button" class="btn btn-primary lms-lottery-button">Register</button>
                </div>
            </div>
        </div>
    </div>
